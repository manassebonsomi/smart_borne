...
class Recommandation(db.Model):
    ...
    id_session = db.Column(db.Integer, db.ForeignKey("session_utilisateur.id_session"), unique=True)
    id_parcours = db.Column(db.Integer, db.ForeignKey("parcours.id_parcours"))