...
def get_utilisateurs():
    users = UtilisateurController.get_all()
    ...
    return jsonify([
        {
            ...
            "prenom": u.prenom,
            "age": u.age,
            "profil": u.type_profil
        }
        for u in users
    ])


@utilisateur_bp.route("/utilisateurs/<int:id_utilisateur>", methods=["GET"])
def get_utilisateur(id_utilisateur):
    utilisateur = UtilisateurController.get_by_id(id_utilisateur)
...
def create_utilisateur():
    data = request.json
    utilisateur = UtilisateurController.create(
            data["nom"],
            data["prenom"],
            data["age"],
