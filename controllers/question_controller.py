...
class QuestionController:
    ...
    @staticmethod
    def create(texte_question, ordre_question, id_categorie):
        try:
            question = Question(
    ...
    @staticmethod
    def get_all():
        return Question.query.order_by(Question.ordre_question).all()
    ...
    @staticmethod
    def update(id_question, texte_question=None, ordre_question=None, active=None):
        try:
            ...
            if texte_question is not None:
                question.texte_question = texte_question

            if ordre_question is not None:
                question.ordre_question = ordre_question
